...
#Label Functions
def Labels():
    title = Label(root, text = "Spleeter Layman", font = "Verdana 18 bold", bg='white')  
    title.pack(side=TOP, expand=None, fill=X, padx=(10, ), pady=(20, 1)) 
    prompt = Label(root, text = "Choose the video to de-music:",font = "Verdana 13 bold", bg='white')  
    prompt.pack(side=TOP, expand=None, fill=X, padx=(10, 20), pady=(10, 10))
...
def get_file_path():
    ...
    file_path= filedialog.askopenfilename(title = "Select A File", filetypes = (("mp4", "*.mp4"), ("mov files", "*.png"), ("wmv", "*.wmv"), ("avi", "*.avi")))
